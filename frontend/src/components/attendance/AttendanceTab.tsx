...
import LogAbsenceDialog, {
  type AttendanceDialogAudience,
} from "./LogAbsenceDialog";
...
export default function AttendanceTab({
  ...
  const summary = useMemo(
    () => summarizeAttendance(records, totalDaysInMonth),
    [records, totalDaysInMonth],
  );
  ...
  const logButtonLabel =
    audience === "teacher" ? "Log attendance" : "Log absence";
